...
from cellar.domain.chemical_registration.enums import MergeReason, StructureStatus
    ...
    async def __call__(
        ...
        async with self._uow:
            ...
            if molecule.structure_status != StructureStatus.UNDISCLOSED:
                return Failure(ValidationError("Only undisclosed molecules can be disclosed"))
