...
class ControlledVocabularyRepository(Protocol):
    ...
    async def find_by_workspace(self, workspace_id: uuid.UUID) -> list[ControlledVocabulary]: ...
...
class ExternalApiKeyRepository(Protocol):
    ...
    async def find_by_workspace(self, workspace_id: uuid.UUID) -> list[ExternalApiKey]: ...
...
class OntologySlotDefinitionRepository(Protocol):
    ...
    async def find_by_workspace(self, workspace_id: uuid.UUID) -> list[OntologySlotDefinition]: ...
