...
from cellar.domain.inventory.enums import VALID_PARENT_TYPES, StorageLocationType
from cellar.domain.inventory.events import StorageLocationCreated
    ...
    def _validate_parent_type(
        ...
        if parent_id is None:
            if None not in valid_parents:
                raise ValidationError(f"StorageLocation of type '{loc_type}' requires a parent")
        else:
