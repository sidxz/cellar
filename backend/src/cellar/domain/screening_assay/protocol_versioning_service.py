...
from cellar.domain.screening_assay.events import ProtocolVersionCreated
...
class ProtocolVersioningService:
    ...
    def create_new_version(self, parent: Protocol) -> Protocol:
        ...
        new_protocol = Protocol(
            ...
            ontology_annotations=copy.deepcopy(parent.ontology_annotations)
            if parent.ontology_annotations
            else None,
