...
class BulkDisclosureModel(Base, EntityModelMixin, WorkspaceIdMixin, VersionMixin):
    ...
    disclosed_count: Mapped[int] = mapped_column(Integer, nullable=False, server_default="0")
    merged_count: Mapped[int] = mapped_column(Integer, nullable=False, server_default="0")
