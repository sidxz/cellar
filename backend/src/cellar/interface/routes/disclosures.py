...
from cellar.application.chemical_registration.get_disclosure import GetDisclosureQuery
from cellar.application.chemical_registration.list_disclosures import ListDisclosuresQuery
from cellar.application.chemical_registration.list_disclosures_by_workspace import (
    ListDisclosuresByWorkspaceQuery,
)
from cellar.application.chemical_registration.reject_disclosure import RejectDisclosureCommand
...
async def submit_disclosure(
    ...
    return DisclosureOutcomeResponse(
        disclosure_request=DisclosureRequestResponse.from_domain(outcome.disclosure_request),
