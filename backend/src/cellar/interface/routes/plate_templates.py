...
async def get_plate_template(
    ...
    query = GetPlateTemplateQuery(workspace_id=auth.workspace_id, template_id=template_id)
...
async def delete_plate_template(
    ...
    command = DeletePlateTemplateCommand(workspace_id=auth.workspace_id, template_id=template_id)
