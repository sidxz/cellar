...
from cellar.application.research_organization.create_saved_search import CreateSavedSearchCommand
from cellar.application.research_organization.delete_saved_search import DeleteSavedSearchCommand
from cellar.application.research_organization.get_saved_search import (
    GetSavedSearchQuery,
    ListSavedSearchesQuery,
)
from cellar.application.research_organization.update_saved_search import UpdateSavedSearchCommand
...
async def get_saved_search(
    ...
    query = GetSavedSearchQuery(workspace_id=auth.workspace_id, saved_search_id=search_id)
...
async def update_saved_search(
    ...
    visibility = (
        body.visibility if "visibility" in provided and body.visibility is not None else None
    )
...
async def delete_saved_search(
    ...
    command = DeleteSavedSearchCommand(workspace_id=auth.workspace_id, saved_search_id=search_id)
