...
class SQLAlchemySampleRequestRepository(
    SQLAlchemyRepository[SampleRequest, SampleRequestModel]
):
    ...
    async def find_by_workspace(
        ...
        stmt = select(SampleRequestModel).where(
            SampleRequestModel.workspace_id == workspace_id
        )
        if status:
