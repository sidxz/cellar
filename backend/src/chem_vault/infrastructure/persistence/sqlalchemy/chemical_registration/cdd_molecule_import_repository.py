...
from chem_vault.infrastructure.persistence.sqlalchemy.chemical_registration.cdd_molecule_import_models import (
...
class SQLAlchemyCddMoleculeImportRepository(
    ...
    def _update_model(
        self, model: CddMoleculeImportModel, aggregate: CddMoleculeImport
    ) -> None:
