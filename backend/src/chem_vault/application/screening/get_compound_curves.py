...
class CompoundCurvesQuery(Query):
...
class GetCompoundCurves:
    ...
    async def __call__(
        self, input: CompoundCurvesQuery, auth: AuthContext | None = None
        ...
        async with self._uow as uow:
            ...
            stmt = (
                ...
                .where(
                    DoseResponseCurveModel.protocol_id == input.protocol_id,
                    DoseResponseCurveModel.molecule_id == input.molecule_id,
                    RunModel.workspace_id == input.workspace_id,
                )
