...
class DisclosureRequestRepository(Protocol):
    ...
    async def find_by_id_in_workspace(self, workspace_id: uuid.UUID, id: uuid.UUID) -> DisclosureRequest | None: ...
    async def find_by_molecule(self, workspace_id: uuid.UUID, molecule_id: uuid.UUID) -> list[DisclosureRequest]: ...
    async def find_by_bulk_disclosure(self, workspace_id: uuid.UUID, bulk_disclosure_id: uuid.UUID) -> list[DisclosureRequest]: ...
...
class MergeEventRepository(Protocol):
    ...
    async def find_by_source(self, workspace_id: uuid.UUID, source_molecule_id: uuid.UUID) -> list[MergeEvent]: ...
    async def find_by_target(self, workspace_id: uuid.UUID, target_molecule_id: uuid.UUID) -> list[MergeEvent]: ...
