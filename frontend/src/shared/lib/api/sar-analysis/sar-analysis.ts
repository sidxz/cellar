 ...
 * @summary Compute Mcs
 */
export const computeMcsApiV1SarMcsPost = (
    computeMcsBody: ComputeMcsBody,
 signal?: AbortSignal
) => {
      
      
      return customInstance<ComputeMcsResponse>(
      {url: `/api/v1/sar/mcs`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: computeMcsBody, signal
    },
      );
    }
...
export const getComputeMcsApiV1SarMcsPostMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof computeMcsApiV1SarMcsPost>>, TError,{data: ComputeMcsBody}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof computeMcsApiV1SarMcsPost>>, TError,{data: ComputeMcsBody}, TContext> => {

const mutationKey = ['computeMcsApiV1SarMcsPost'];
const {mutation: mutationOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof computeMcsApiV1SarMcsPost>>, {data: ComputeMcsBody}> = (props) => {
          const {data} = props ?? {};

          return  computeMcsApiV1SarMcsPost(data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ComputeMcsApiV1SarMcsPostMutationResult = NonNullable<Awaited<ReturnType<typeof computeMcsApiV1SarMcsPost>>>
    export type ComputeMcsApiV1SarMcsPostMutationBody = ComputeMcsBody
    export type ComputeMcsApiV1SarMcsPostMutationError = HTTPValidationError

    /**
 * @summary Compute Mcs
 */
export const useComputeMcsApiV1SarMcsPost = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof computeMcsApiV1SarMcsPost>>, TError,{data: ComputeMcsBody}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof computeMcsApiV1SarMcsPost>>,
        TError,
        {data: ComputeMcsBody},
        TContext
      > => {

      const mutationOptions = getComputeMcsApiV1SarMcsPostMutationOptions(options);
