...
function UploadStep({
  ...
  return (
    <div className="py-2">
      {/* Click-to-browse forwards to the hidden, keyboard-accessible file input. */}
      {/* biome-ignore lint/a11y/useKeyWithClickEvents: dropzone delegates keyboard interaction to the inner file <input>. */}
      <div
        onDrop={onDrop}
        onDragOver={(e) => {
          e.preventDefault();
