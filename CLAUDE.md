...
**How to resume:**
1. **Push** — `prot-2` is N commits ahead of `e807dd03` (use `git rev-list --count e807dd03..HEAD`), smoked, nothing pushed. `git push -u origin prot-2` (or merge straight to `main` if you're done with the branch).
