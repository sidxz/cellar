...
**Verification:**
- Backend: 2422 → 2438 → 456 → 2424 → 2452 green at each commit (final sweep after Surface #7). No backend touched in commit #12.
...
- **Browser smoke: PASSED on 2026-05-14** against the live `Mtb_WCA_mc2-7000_Resazurin` protocol — Surfaces #1–#7 walk cleanly. The unified Export menu (commit #12, Surface #8) ships untested in browser; needs a follow-up smoke covering Excel / CSV / SDF download paths from a populated search.
